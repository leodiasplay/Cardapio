...
<div class="menu-section">
    ...
    $sql = "SELECT titulo, descricao, foto, valor_venda FROM itens i WHERE i.Nome_empresa = 'UAM'";  // Nome da empresa fixo na query
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    submitButton.addEventListener('click', function() {
        ...
        window.open('https://wa.me/5516991716876?text=' + encodeURIComponent(message));
