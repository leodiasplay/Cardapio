...
<div class="menu-section">
    ...
    $sql = "SELECT titulo, descricao, foto, valor_venda FROM itens i WHERE i.Nome_empresa = 'Caputti'";  // Nome da empresa fixo na query
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    submitButton.addEventListener('click', function() {
        ...
        window.open('https://wa.me/5516992912895?text=' + encodeURIComponent(message));
